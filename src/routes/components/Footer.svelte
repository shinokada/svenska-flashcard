...
<Footer class="shadow-none dark:bg-blue-950" footerType="logo">
  <div class="sm:flex sm:items-center sm:justify-between">
    ...
    <FooterLinkGroup class="mt-3 flex flex-wrap items-center gap-2 text-sm text-gray-500 sm:mt-0 sm:pl-4 dark:text-gray-400">
      <FooterLink href="https://multilanguage-flashcard.codewithshin.com/">Multilanguage flashcard</FooterLink>
