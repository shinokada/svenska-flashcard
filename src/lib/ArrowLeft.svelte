...
<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} {role} aria-label={ariaLabel} fill="none" {viewBox} stroke-width={strokeWidth} {...attributes} class={classname}>
  {#if variation === 'outline'}
    <path d="M10.5 19.5L3 12M3 12L10.5 4.5M3 12H21" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
