...
<svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} {role} aria-label={ariaLabel} fill="none" {viewBox} stroke-width={strokeWidth} class={classname} {...attributes}>
  {#if variation === 'outline'}
    <path d="M13.5 4.5L21 12M21 12L13.5 19.5M21 12H3" stroke={color} stroke-width={strokeWidth} stroke-linecap="round" stroke-linejoin="round" />
